...
RSpec.describe 'Tweets', type: :system do
  ...
  scenario "user can't create a new tweet" do
    ...
    fill_in 'tweet[content]',
            with: 'jmgovmkso@mngasnmgko@angoasngoskngnwa[[;;lc@asdk@opgwegwajmgians@gomsrognaijghmelprjgmioesrjmgposdgjms@irjgo@eapkgmeiorgjerpojmhkodmhopbdmrgkgnaisormgoenhio@drekmgenmgheoprjnhiger@amghoksm'
    click_button 'ポストする'
