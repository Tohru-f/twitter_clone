...
favorite1.tweet.create_notification_favorite!(favorite1.user) unless Rails.env.test?
...
favorite2.tweet.create_notification_favorite!(favorite2.user) unless Rails.env.test?
...
retweet1.tweet.create_notification_retweet!(retweet1.user) unless Rails.env.test?
...
retweet2.tweet.create_notification_retweet!(retweet2.user) unless Rails.env.test?
